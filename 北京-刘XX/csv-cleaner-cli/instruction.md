...
```
name,age,signup_date,city
  John Doe  ,  30  ,03/15/2023,New York
Jane Smith,25,2023-03-20,Los Angeles

John Doe,30,03/15/2023,New York
  ,  ,  ,
Bob Wilson,40,March 1, 2023,Chicago
```

**Expected Output (cleaned_data.csv):**
```
name,age,signup_date,city
John Doe,30,2023-03-15,New York
Jane Smith,25,2023-03-20,Los Angeles
Bob Wilson,40,2023-03-01,Chicago
```

**What changed:**
- Whitespace trimmed from all cells
- Empty rows removed
- Duplicate "John Doe" row removed (after trimming, it matched the first occurrence)
- Date `03/15/2023` normalized to `2023-03-15`
- Date `March 1, 2023` normalized to `2023-03-01`
